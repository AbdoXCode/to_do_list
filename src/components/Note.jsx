  ...
  return (
    <section>
      <article className="flex justify-between items-center max-w-120 border p-4 rounded-sm mb-4 shadow-sm hover:shadow-md transition-shadow duration-200 m-2">
        ...
        <div>
          <button className="border-0 p-1 rounded-sm bg-green-700 hover:bg-green-800 cursor-pointer outline-0 mr-2">
            <svg
          ...
          <button className="border-0 p-1 rounded-sm bg-red-700 hover:bg-red-800 cursor-pointer outline-0">
            <svg
              className="w-5 h-5 text-white dark:text-white"
              aria-hidden="true"
              xmlns="http://www.w3.org/2000/svg"
